...
$rentals = $conn->query("SELECT * FROM `rentals` INNER JOIN rental_details ON rentals.rental_id = rental_details.rental_id INNER JOIN products ON rental_details.product_id = products.product_id WHERE rentals.member_id = '".$_SESSION["id"]."' AND rentals.rental_id = '".$_GET['id']."'");
        ...
        <div class="row px-xl-5">
            <div class="col-lg-12 table-responsive mb-5">
                ...
                <div class="offset-9 row">
                    <a href="list_Payments.php" class="btn btn-warning">
